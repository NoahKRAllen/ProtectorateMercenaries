...
public class CameraController : MonoBehaviour
{
    ...
    [Header("Move Settings")] [SerializeField] private bool drawBounds;
    [SerializeField] private Bounds cameraBounds;
    [SerializeField] private float camSpeed;
    [SerializeField] private Vector2 screenPercentageDetection;
    [Header("Zoom Settings")] [SerializeField] private float minZoomDistance;
    [SerializeField] private float maxZoomDistance;
    [SerializeField] private float zoomSpeed;
    [Header("Camera Start Positions")] [SerializeField] private Vector3 redTeamPosition = new(150f, 0f, 150f);
    [SerializeField] private Vector3 blueTeamPosition = new(-150f, 0f, -150f);
    ...
    private void Awake()
    {
        ...
        _transposer = cinemachineVirtualCamera.GetComponent<CinemachinePositionComposer>();
    }
    /*private void Start()
    { 
        ...
        { 
            ...
            var cameraPosition = team switch { TeamType.Blue => _blueTeamPosition, TeamType.Red => _redTeamPosition, _ => _spectatorPosition }; 
            transform.position = cameraPosition; if (team != TeamType.AutoAssign) { _cameraSet = true; } 
        } 
    }*/
    ...
    private void ZoomCamera()
    {
        ...
        {
            _transposer.CameraDistance -= Input.mouseScrollDelta.y * zoomSpeed * Time.deltaTime;
            _transposer.CameraDistance =
                Mathf.Clamp(_transposer.CameraDistance, minZoomDistance, maxZoomDistance);
        }
    }
    /*private void SetCameraForAutoAssignTeam()
    {
        ...
        { 
            ...
            { 
                ...
                var cameraPosition = team switch { TeamType.Blue => _blueTeamPosition, TeamType.Red => _redTeamPosition, _ => _spectatorPosition }; 
                transform.position = cameraPosition; _cameraSet = true; 
            } 
        } 
    }*/
